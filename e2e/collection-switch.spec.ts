...
/**
 * Owned | Wishlist is one control on two pages, so it stands in one place at one size on both:
...
test("Owned and Wishlist are the same width on both pages", async ({ page }) => {
