...
House rules on top of the kit's own guide above. They live outside the embedded block so a refresh
of the upstream file keeps them.
...
skeuomorphic inset shine on buttons is off: it was a second edge inside the first.
