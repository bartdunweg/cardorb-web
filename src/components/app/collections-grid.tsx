...
function FolderCard({
    ...
    return (
        <Link
            href={href}
            className={cx(
                "flex pressable gap-3 rounded-xl bg-primary p-4 shadow-border outline-focus-ring transition-[color,background-color,box-shadow] hover:shadow-border_hover focus-visible:outline-2",
