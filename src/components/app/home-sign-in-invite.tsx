 ...
 * one thing; the rows are text, since opening a card from here would read the reader's own rows.
 */
    ...
    return (
        <Place heading="Biggest movers this week" line="The cards whose price moved most in the last 7 days, across every card there is">
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
                <MoverList title="Up" movers={movers.up} empty="Nothing rose this week." href={null} linkLabel="" />
                <MoverList title="Down" movers={movers.down} empty="Nothing fell this week." href={null} linkLabel="" />
            </div>
        </Place>
    );
}
