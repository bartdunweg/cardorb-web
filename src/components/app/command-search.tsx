...
export function SidebarSearchTrigger() {
    ...
    return (
        <button
            type="button"
            onClick={open}
            className="flex w-full cursor-pointer items-center gap-2 rounded-full bg-primary px-3 py-2 text-sm text-tertiary shadow-xs ring-1 ring-primary outline-focus-ring ring-inset hover:bg-secondary focus-visible:outline-2"
        >
