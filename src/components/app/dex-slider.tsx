    ...
    return (
        <div className="group relative aspect-card w-full overflow-hidden rounded-card">
            ...
            <ButtonUtility
                ...
                onClick={() => scroll(-1)}
                className="absolute top-1/2 left-1 hidden -translate-y-1/2 bg-alpha-black/60 text-alpha-white hover:bg-alpha-black/60 hover:text-alpha-white focus-visible:outline-offset-0 sm:group-focus-within:inline-flex sm:group-hover:inline-flex pointer-coarse:inline-flex"
            />
            <ButtonUtility
                size="xs"
                color="tertiary"
                ...
                onClick={() => scroll(1)}
                className="absolute top-1/2 right-1 hidden -translate-y-1/2 bg-alpha-black/60 text-alpha-white hover:bg-alpha-black/60 hover:text-alpha-white focus-visible:outline-offset-0 sm:group-focus-within:inline-flex sm:group-hover:inline-flex pointer-coarse:inline-flex"
            />
        </div>
    );
}
