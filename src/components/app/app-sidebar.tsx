...
// from a Server Component. The collection is one set of cards with three views on it: all of
// them, by set, by Pokémon. Under Folders sit two that are always there, Favorites and Wishlist,
