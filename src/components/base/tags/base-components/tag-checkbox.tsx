    ...
    return (
        ...
        >
            <svg
                ...
                fill="none"
                className={cx(
                    // Brand-solid is near-white in dark mode: the tick goes black there, as in checkbox.tsx.
                    "pointer-events-none absolute text-fg-white opacity-0 transition-inherit-all dark:text-black",
                    size === "sm" && "size-2.5",
                    size === "md" && "size-3",
                    size === "lg" && "size-3.5",
