        ...
        <AriaTooltipTrigger {...{ trigger, delay, closeDelay, isDisabled, isOpen, defaultOpen, onOpenChange }}>
            ...
            <AriaTooltip
                ...
                className={({ isEntering, isExiting }) =>
                    cx(
                        isEntering && "duration-(--duration-fast) animate-in [animation-timing-function:var(--ease-enter)]",
                        isExiting && "duration-(--duration-instant) animate-out [animation-timing-function:var(--ease-enter)]",
                    )
                }
            >
