        ...
        <AriaTooltipTrigger {...{ trigger, delay, closeDelay, isDisabled, isOpen, defaultOpen, onOpenChange }}>
            ...
            <AriaTooltip
                ...
                className={({ isEntering, isExiting }) =>
                    cx(
                        isEntering && "duration-125 animate-in [animation-timing-function:var(--ease-enter)]",
                        isExiting && "duration-100 animate-out [animation-timing-function:var(--ease-enter)]",
                    )
                }
            >
