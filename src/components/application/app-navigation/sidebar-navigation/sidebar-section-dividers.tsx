...
export const SidebarNavigationSectionDividers = ({
    ...
    const content = (
        <aside
            ...
            className="flex h-full w-full max-w-full flex-col justify-between overflow-auto glass pt-4 shadow-xs ring-glass ring-inset lg:w-(--width) lg:rounded-xl lg:pt-5 lg:ring-1"
        >
