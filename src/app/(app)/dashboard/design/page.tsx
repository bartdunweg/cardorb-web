                ...
                <KitGallery>
                    <section id="still-by-hand" className="flex scroll-mt-24 flex-col gap-3 lg:scroll-mt-6">
                        ...
                        <p className="max-w-2xl text-sm text-tertiary">
                            ...
                            component. Some are whole clickable card tiles, which the kit has no answer for — those want a named component of ours rather than
                            the kit&rsquo;s button. A site with a reason written above it is a decision, not drift, and is not counted here.
                        </p>
