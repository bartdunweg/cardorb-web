...
// The first hundred owned cards behind a public profile, with the totals behind them. The paged
// route rather than the whole collection: a hundred tiles need thirty kilobytes, not nine hundred.
// The API publishes nothing personal on it (R-API-002 there), so nothing here has to be hidden.
